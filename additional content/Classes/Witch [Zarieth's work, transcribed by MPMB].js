...
ClassList["witch-zarieth"] = {
	...
	saves : ["Wis", "Cha"],
	skillstxt : {
		primary : "Choose two from Arcana, Animal Handling, History, Insight, Medicine, Nature, and Religion."
	},
	toolProfs : {
	...
	features : {
		...
		"binding rites" : {
			...
			action : [['bonus action', 'Release Spirit Bond']],
			toNotesPage : [{
				name : "Witch's Spirit Bonds",
				page3notes : true,
				additional : "releasing is a bonus action unless otherwise noted",
				note : [
		...
		"strength of spirit" : {
			...
			additional : levels.map( function(n) { return n < 15 ? "" : n + "\u00D7 bonded spirits"; })
		},
		"familiar spirit" : {
...
AddSubClass("witch-zarieth", "covenant of blood", {
...
AddSubClass("witch-zarieth", "covenant of charm", {
...
AddSubClass("witch-zarieth", "covenant of ruin", {
...
AddSubClass("witch-zarieth", "covenant of shadows", {
...
AddSubClass("witch-zarieth", "covenant of unity", {
