...
SourceList["WH:AU"] = {
	...
	url : "https://www.dmsguild.com/product/222229/WH-Awakened-Undead-A-character-race-with-six-subraces-Skeletons-Ghosts-Revenants-Ghouls-Mummies-and-Necropolitans",
	date : "2017/09/22"
};
...
RaceList["ghost-au"] = {
	...
	scorestxt : "+1 Constitution, and +2 Wisdom or Charisma",
	scores : [0, 0, 1, 0, 0, 0],
	features : {
		"incorporeal stride" : {
...
FeatsList["ghostly magic-au"] = {
	...
	prereqeval : function(v) { return wasm_character.get_race_id().indexOf('ghost-au') !== -1; },
...
FeatsList["tomb magic-au"] = {
	...
	prereqeval : function(v) { return wasm_character.get_race_id().indexOf('mummy-au') !== -1; },
...
RaceList["revenant-au"] = {
	...
	weight : " weight is determined by the race it was in life",
	savetxt : { immune : ["poison", "disease"] },
	scorestxt : "+1 Constitution, and +2 Strength or Charisma",
	scores : [0, 0, 1, 0, 0, 0],
	features : {
		"unnatural vitality" : {
